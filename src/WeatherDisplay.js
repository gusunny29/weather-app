  ...
  return (
    <Grid container spacing={2}>
      <Grid item xs={12}>
        ...
        <Box display="flex" justifyContent="center" textAlign="center" mb={2}>
          <Typography variant="h6">This {selectedDayOfWeek} ({selectedDayFormatted})</Typography>
        </Box>
      ...
      <Grid item xs={12}>
        <Box display="flex" justifyContent="center" textAlign="center" mb={2}>
          <Typography variant="h6">Next {nextWeekDayOfWeek} ({nextWeekDayFormatted})</Typography>
        </Box>
        <Box display="flex" alignItems="center">
